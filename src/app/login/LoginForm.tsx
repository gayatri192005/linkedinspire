  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <Link href="/" className="inline-flex items-center text-[#0A66C2] hover:text-[#0077B5] mb-8 transition-colors duration-200">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-[#0A66C2]/10 border border-white/50 p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" id="email" name="email" value={formData.email} onChange={handleChange}
                  className={cn("w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#0A66C2]/20 focus:border-[#0A66C2] transition-all duration-200 bg-white/90 backdrop-blur-sm", errors.email ? "border-red-500 bg-red-50" : "border-gray-300")}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? "text" : "password"} id="password" name="password" value={formData.password} onChange={handleChange}
                  className={cn("w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-[#0A66C2]/20 focus:border-[#0A66C2] transition-all duration-200 bg-white/90 backdrop-blur-sm", errors.password ? "border-red-500 bg-red-50" : "border-gray-300")}
          ...
          <div className="text-center">
            <Link href="/signup" className="text-[#0A66C2] hover:text-[#0077B5] font-medium transition-colors duration-200">
