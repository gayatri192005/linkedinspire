          ...
          {speakers.length === 0 ? (
            ...
            <div key={speaker.id} className="bg-white rounded-2xl p-6 border border-[#E8E8E8] shadow-sm hover:shadow-lg hover:border-[#0A66C2]/30 transition-all duration-300 group">
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                >
                  <svg role="img" viewBox="0 0 24 24" width={20} height={20} fill="currentColor" className="w-5 h-5 text-[#0A66C2] group-hover:text-white transition-colors duration-300"><path d={linkedinPath} /></svg>
                </a>
              </div>
